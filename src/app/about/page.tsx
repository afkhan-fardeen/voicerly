...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Your recordings are yours alone with complete privacy.",
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8 text-cyan-400" fill="currentColor" viewBox="0 0 20 20">
        <path
          fillRule="evenodd"
          d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.666.804 4.332A1 1 0 0113 20H7a1 1 0 01-.985-.802L5.123 15.666 5.22 15H3a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z"
          clipRule="evenodd"
        />
      </svg>
    ),
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            The modern way to record, upload, and share audio instantly. No downloads, no sign-ups, just pure audio sharing magic.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div className="bg-white/60 dark:bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-gray-200/60 dark:border-white/10 shadow-sm">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              At Voicerly, we aim to democratize audio creation and sharing. We believe everyone should have access to professional-grade voice recording tools without barriers.
            </p>
          </div>
          ...
          <div className="bg-white/60 dark:bg-white/5 backdrop-blur-xl rounded-xl p-6 border border-gray-200/60 dark:border-white/10 shadow-sm">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              We envision a world where sharing audio is as simple as sending a text message. Whether you are a podcaster, professional, or student, Voicerly provides a secure, user-friendly solution.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((feature, index) => (
              <div
                key={index}
                className="bg-white/60 dark:bg-white/5 backdrop-blur-xl rounded-xl p-5 border border-gray-200/60 dark:border-white/10 shadow-sm hover:shadow transition-all duration-200"
              >
